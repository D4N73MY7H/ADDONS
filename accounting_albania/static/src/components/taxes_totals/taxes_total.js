...
//Shtimi i widgetit account-taxes-totals-field qe ne momentin qe behet triger kur ndryshon monedha te marri monedhes e kompanise gjate formatimit.
/**
...
/**
 ...
 currency_id field.
 **/
export class TaxesTotalsComponent extends Component {
    setup() {
        this.totals = {};
    ...
    get currencyId() {
        ...
        console.log(recordCurrency,"Record currency")
    ...
    formatData(props) {
        ...
        const currencyFmtOpts = { currencyId: props.record.data.company_currency_id && props.record.data.company_currency_id[0] };
        console.log(currencyFmtOpts,"Currency on FMTOPTS")
...
TaxesTotalsComponent.template = "account.TaxTotalsField";
TaxesTotalsComponent.components = { TaxGroupComponent };
TaxesTotalsComponent.props = {
    ...standardFieldProps,
};

export const taxesTotalsComponent = {
    component: TaxesTotalsComponent,
};

registry.category("fields").add("account-taxes-totals-field", taxesTotalsComponent);
